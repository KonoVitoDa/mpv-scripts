...
function fn_cut_finish(p1,p2)
  if(start_time_seconds == nil or end_time_seconds == nil) then
    ...
    local output_filename = mp.get_property("filename/no-ext").."_"..string.gsub(start_time_formated,":",".").." – "..string.gsub(end_time_formated,":",".").." 【FFmpeg】".."."..output_format
...
function fn_cut_finish_gif(p1,p2)
  if(start_time_seconds == nil or end_time_seconds == nil) then
    ...
    local output_directory, _ = utils.split_path(mp.get_property("path"))
    local output_filename = mp.get_property("filename").."_snapshot_"..string.gsub(start_time_formated,":",".").." – "..string.gsub(end_time_formated,":",".").."."..output_format
    local output_path = utils.join_path(output_directory, output_filename)
